...
CMainFrameBase::CMainFrameBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxFrame(parent, id, title, pos, size, style)
{
	...
	bSizer3->Add(m_panel14, 1, wxEXPAND | wxALL, 5);//bSizer3->Add(m_panel14, 1, wxEXPAND|wxALIGN_BOTTOM|wxALL, 5);
...
COptionsDialogBase::COptionsDialogBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText32->Wrap(-1);
	bSizer57->Add(m_staticText32, 0, wxALL, 5);//bSizer57->Add(m_staticText32, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
	...
	bSizer56->Add(m_staticText31, 0, wxTOP | wxBOTTOM | wxLEFT, 5);//bSizer56->Add(m_staticText31, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5);

    m_textCtrlTransactionFee = new wxTextCtrl(this, wxID_TRANSACTIONFEE, wxEmptyString, wxDefaultPosition, wxSize(70,-1), 0);
	bSizer56->Add(m_textCtrlTransactionFee, 0, wxALL, 5);//bSizer56->Add(m_textCtrlTransactionFee, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
...
CAboutDialogBase::CAboutDialogBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	...
	bSizer60->Add(bSizer61, 0, wxEXPAND, 5);//bSizer60->Add(bSizer61, 0, wxALIGN_RIGHT|wxEXPAND, 5);

	this->SetSizerAndFit(bSizer60);//this->SetSizer(bSizer60);
    this->Layout();
...
CSendDialogBase::CSendDialogBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	...
	fgSizer1 = new wxFlexGridSizer(4, 2, 0, 0);//fgSizer1 = new wxFlexGridSizer(3, 2, 0, 0);
	...
	this->SetSizerAndFit(bSizer21);//this->SetSizer(bSizer21);
    this->Layout();
...
CGetTextFromUserDialogBase::CGetTextFromUserDialogBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	...
	bSizer81->Add(m_textCtrl1, 0, wxALL | wxEXPAND, 5);//bSizer81->Add(m_textCtrl1, 0, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5);
	...
	bSizer81->Add(m_textCtrl2, 0, wxALL | wxEXPAND, 5);//bSizer81->Add(m_textCtrl2, 0, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL, 5);
	...
	this->SetSizerAndFit(bSizer79);//this->SetSizer(bSizer79);
    this->Layout();
